...
async function startServer() {
  ...
  app.listen(PORT, () => {
    ...
    console.log(`   POST /call/initiate          - Initiate a marketing call`);
    ...
    console.log(`     -d '{"customerPhone": "+1234567890", "campaign": {"name": "Pizza Palace", "promotion": "50% off all pizzas this weekend!", "discount": "50%", "valid_until": "Sunday"}}'`);
    console.log("");
    console.log("📝 Example: Get calls for a phone number:");
    console.log(`   curl http://localhost:${PORT}/customers/+1234567890/calls`);
  });
}
